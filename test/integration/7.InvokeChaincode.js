...
test('Invoke chaincode channel code mycc3 in org2 on mychannel ', (t) => {
...
test('Invoke chaincode channel code mycc in org1 on mychannel with error endorsing peer', (t) => {
    sendToGateway('org1', route,
        {
            "chaincodeName": "mycc",
            "channelName": "mychannel",
        ...
        t.equal(e, 'The transaction was invalid, code = ENDORSEMENT_POLICY_FAILURE');
        t.end()
    })
})
